...
export async function seedEngravingAreas(
  ...
  const productEngravingAssociations: ProductEngravingAssociation[] = [
    // Picture Necklaces - Image engravings for personalized photos
    {
      productSlug: "picture-necklaces",
      engravingAreas: [
        {
          name: "Front",
          engravingType: "image", // Main photo/image on the front of the pendant
          displayOrder: 1,
          referenceImage: "/images/sample-product/2.jpg",
        },
        {
          name: "Back",
          engravingType: "image", // Secondary photo/image on the back of the pendant
          displayOrder: 2,
          referenceImage: "/images/sample-product/3.jpg",
        },
      ],
    },

    // Engraved Executive Bracelets - Text engravings for professional personalization
    {
      productSlug: "engraved-executive-bracelets",
      engravingAreas: [
        {
          name: "Engraving",
          engravingType: "text", // Professional text engraving for names, titles, or messages
          maxCharacters: 50,
          displayOrder: 1,
          referenceImage: "/images/sample-product-2/2.jpg",
        },
      ],
    },
